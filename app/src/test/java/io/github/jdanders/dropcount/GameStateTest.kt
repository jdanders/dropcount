...
class GameStateTest {
    ...
    fun testGetRowPositions() {
        ...
        assertEquals(GridPosition(Row(3), Col(0)), positions[0])
        assertEquals(GridPosition(Row(3), Col(6)), positions[6])
    }
    ...
    fun testGetColumnPositions() {
        ...
        assertEquals(7, positions.size)
        assertEquals(GridPosition(Row(0), Col(4)), positions[0])
        assertEquals(GridPosition(Row(6), Col(4)), positions[6])
    }
